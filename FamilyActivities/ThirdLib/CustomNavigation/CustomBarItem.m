...
#define Default_Offset (([[[UIDevice currentDevice]systemVersion]floatValue] >= 7.0)? - 10:0)
...
+ (CustomBarItem *)itemWithTitle:(NSString *)title textColor:(UIColor *)color fontSize:(CGFloat )font itemType:(ItemType)type
{
    ...
    [item.itemDefaultChildView.titleLabel setFont:[UIFont boldSystemFontOfSize:font]];
    return item;
}
